<template>
    <div>
        ...
        <div class="mb-5">
            <label class="font-bold mb-1 text-gray-700 block">NID Image - Front Side</label>
            ...
            <div>
                <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                >
                    <path fill="#E0E0E0" d="M.812 0h283.375v152H.812z" />
                    <path
                        d="M119.474 129.433V117.59c0-6.281-2.5-12.306-6.951-16.748a23.758 23.758 0 00-16.781-6.937H48.277a23.758 23.758 0 00-16.781 6.937 23.663 23.663 0 00-6.951 16.748v11.843M72.01 70.22c13.106 0 23.732-10.604 23.732-23.685S85.116 22.85 72.009 22.85c-13.107 0-23.732 10.604-23.732 23.685 0 13.08 10.625 23.685 23.732 23.685z"
                        stroke="#A3A3A3"
                        stroke-width="8"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                    />
                    <path
                        d="M135 68.5a7.5 7.5 0 017.5-7.5h110a7.5 7.5 0 010 15h-110a7.5 7.5 0 01-7.5-7.5zM135 86.569a4.097 4.097 0 014.097-4.097H202.1a4.097 4.097 0 110 8.193h-63.003A4.097 4.097 0 01135 86.57zM135 100.978a4.097 4.097 0 014.097-4.097h92.669a4.096 4.096 0 010 8.193h-92.669a4.096 4.096 0 01-4.097-4.096zM135 115.387a4.097 4.097 0 014.097-4.097h92.669a4.096 4.096 0 010 8.193h-92.669a4.096 4.096 0 01-4.097-4.096z"
                        fill="#F2F2F2"
                    />
                </svg>
            </div>
        ...
        <div class="mb-5">
            ...
            <div>
                <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                >
                    <path fill="#E0E0E0" d="M0 0h283.375v152H0z" />
                    <path
                        d="M17 27.415a7.5 7.5 0 017.5-7.5h110a7.5 7.5 0 010 15h-110a7.5 7.5 0 01-7.5-7.5zM17 48a4 4 0 014-4h142a4 4 0 010 8H21a4 4 0 01-4-4zM17 62a4 4 0 014-4h93a4 4 0 010 8H21a4 4 0 01-4-4zM17 76a4 4 0 014-4h93a4 4 0 010 8H21a4 4 0 01-4-4z"
                        fill="#F2F2F2"
                    />
                    <g clip-path="url(#clip0)">
                        <path
                            d="M206 125h36c3.309 0 6-2.691 6-6V95c0-3.31-2.691-6-6-6h-30l-12 12v18c0 3.309 2.691 6 6 6zm18-21v6h-6v-6h6zm0-9v6h-6v-3c0-1.66 1.341-3 3-3h3zm12 6v-6h3c1.659 0 3 1.34 3 3v3h-6zm0 9v-6h6v6h-6zm0 9v-6h6v3c0 1.659-1.341 3-3 3h-3zm-9 0V95h6v24h-6zm-6 0c-1.659 0-3-1.341-3-3v-3h6v6h-3z"
                            fill="#F3F1F1"
                        />
                    </g>
                    <defs>
                        <clipPath id="clip0">
                            <path
                                fill="#fff"
                                transform="rotate(-90 162.5 -37.5)"
                                d="M0 0h36v48H0z"
                            />
                        </clipPath>
                    </defs>
